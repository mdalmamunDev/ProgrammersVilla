      ...
      <nav className="py-2">
        <div className="container d-flex flex-wrap">
          <ul className="nav me-auto">
            <li className="nav-item"><a href="#" className="nav-link link-body-emphasis px-2 text-light active" aria-current="page">Home</a></li>
            ...
            <li className="nav-item"><a href="#" className="nav-link link-body-emphasis px-2 text-light">FAQs</a></li>
      ...
      <header className="py-3 mb-4">
        <div className="container d-flex flex-wrap justify-content-center">
          <a href="/" className="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto link-body-emphasis text-decoration-none">
            ...
            <span className="fs-1 text-light">ProgrammerVilla</span>
          </a>
